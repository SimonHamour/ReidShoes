...
<body style="{(!udin ? '--tw-text-opacity: 1;color: rgb(17 24 39 / var(--tw-text-opacity)); background-image: url(\'https://gifdb.com/images/high/lavender-cartoon-clouds-background-u7w65rqbor29e7wi.webp\');' : '--tw-text-opacity: 1;color: rgb(243 244 246 / var(--tw-text-opacity)) /* #f3f4f6 */; background-image: url(\'https://gifdb.com/images/high/pixelated-star-background-e09dbw6zvuyp420b.gif\');')}" 
class="font-sans antialiased leading-normal tracking-wider bg-cover overflow-auto">
    ...
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div id="profile"
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                    style="background-image: url('https://cdn.pixabay.com/photo/2016/03/23/04/01/woman-1274056_960_720.jpg')"></div>
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img src="https://cdn.pixabay.com/photo/2016/03/23/04/01/woman-1274056_960_720.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
        ...
        <div class="absolute top-0 right-0 h-12 w-18 p-4">
            <button class="js-change-theme rounded-lg bg-green-500">🌙</button>
        </div>
...
<script lang="ts">
    ...
    onMount(()=> {
		//Toggle mode
		let toggle = document.querySelector('.js-change-theme') ?? new HTMLElement();
		let profile = document.getElementById('profile') ?? new HTMLElement();
